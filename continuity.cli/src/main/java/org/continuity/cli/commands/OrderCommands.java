...
public class OrderCommands {
	...
	private Order initializeOrder() {
		...
		List<UserInput> covariates = new LinkedList<UserInput>();
		covariates.add(measurement);
		ForecastOptions forecastOpt = new ForecastOptions("2019/01/01 00:00:00", "daily, hourly, minutely or secondly", "telescope or prophet");
