...
public class ForecastPipelineManager {
	 ...
	 * Constructor.
	 */
	public ForecastPipelineManager(RestTemplate restTemplate, InfluxDB influxDb, String tag, Context context) {
	 ...
	 */
	private ForecastBundle generateForecastBundle(SessionsBundlePack sessionsBundles) throws IOException, ParseException, ExtractionException {
